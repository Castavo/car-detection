...
frames_info = extract_frames_info("data/train.csv", skip_prefixes=[SIMILAR_PREFIXES[0]])
frames_info = remove_small_bb(frames_info)

classifier = HOGClassifier(goal_shape=(64, 64), pixels_per_cell=(8, 8), orientations=8, cells_per_block=(3, 3))
...
# with open("data/hog/features/train_64_8.pkl", "wb") as pickle_file:
...
val_features, val_labels = classifier.features_labels(val_frames_info, N_PROCESSES, augment=False, n_negatives=4)
